...
const project = [
    ...
    },
    {
        ...
        repo: 'https://github.com/jcgilbert70/email-contact-form.git',
        img: emailContact,
        caption: 'Email Contact Form',
    },
    {
        link: 'https://jcgilbert70.github.io/password-generator/',
        repo: 'https://github.com/jcgilbert70/password-generator.git',
        img: passwordGenerator,
        caption: 'Password Generator',
    },
    {
        link: 'https://jcgilbert70.github.io/code-quiz/',
        repo: 'https://github.com/jcgilbert70/code-quiz.git',
        img: codeQuiz,
        caption: 'Code Quiz',
    },
    {
        link: 'https://jcgilbert70.github.io/work-scheduler/',
        repo: 'https://github.com/jcgilbert70/work-scheduler.git',
        img: workScheduler,
